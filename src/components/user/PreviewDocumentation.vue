...
<template>
  <aside class="md:bg-vibrant-light-600 mx-2.5 md:py-8 md:px-5 flex flex-col gap-2 rounded-[40px] max-w-[250px] min-w-[250px] absolute top-0 left-0 h-full z-4 md:static">
